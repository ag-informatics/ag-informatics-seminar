## Code Source: https://machinelearningmastery.com/binary-classification-tutorial-with-the-keras-deep-learning-library/
## Using dataset: https://archive.ics.uci.edu/ml/datasets/Connectionist+Bench+(Sonar,+Mines+vs.+Rocks)
## Class Contributor: Gaby

### Section 2. Baseline Neural Network Model Performance
import pandas as pd
...
### Section 3. Re-Run the Baseline Model with Data Preparation
...
### Section 4.1. Evaluate a Smaller Network
